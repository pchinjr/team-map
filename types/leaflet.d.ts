...
import * as geojson from "./geojson.d.ts";
...
export namespace DomUtil {
  ...
  function getScale(
    el: HTMLElement,
  ): { x: number; y: number; boundingClientRect: DOMRect };
...
export type LeafletKeyboardEventHandlerFn = (
...
export class Polygon<P = any>
  extends Polyline<geojson.Polygon | geojson.MultiPolygon, P> {
  constructor(
    latlngs: LatLngExpression[] | LatLngExpression[][] | LatLngExpression[][][],
    options?: PolylineOptions,
  );
...
export namespace Util {
  ...
  function extend<D extends object, S1 extends object = {}>(
    dest: D,
    src?: S1,
  ): D & S1;
